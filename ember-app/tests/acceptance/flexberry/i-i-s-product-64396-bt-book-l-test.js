...
moduleForAcceptance('[AGAT] Acceptance | i i s product 64396 bt book l');

test('testing i-i-s-product-64396-bt-book-l', function(assert) {
  visit('/i-i-s-product-64396-bt-book-l');
