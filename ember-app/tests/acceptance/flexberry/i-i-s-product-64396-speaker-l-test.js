...
moduleForAcceptance('[AGAT] Acceptance | i i s product 64396 speaker l');

test('testing i-i-s-product-64396-speaker-l', function(assert) {
  visit('/i-i-s-product-64396-speaker-l');
